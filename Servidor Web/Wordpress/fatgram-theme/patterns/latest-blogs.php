...
<!-- wp:group {"className":"latestblog-box-wrap wow zoomIn","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|40","top":"var:preset|spacing|40","right":"var:preset|spacing|40","left":"var:preset|spacing|40"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group latestblog-box-wrap wow zoomIn" style="padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)"><!-- wp:query {"queryId":14,"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":null,"parents":[],"format":[]}} -->
...
<!-- wp:column {"width":"20%","className":"latest-blogs-sidebar wow fadeInRight"} -->
<div class="wp-block-column latest-blogs-sidebar wow fadeInRight" style="flex-basis:20%"><!-- wp:template-part {"slug":"sidebar","theme":"healthy-food-blogger","area":"uncategorized"} /--></div>
<!-- /wp:column -->
