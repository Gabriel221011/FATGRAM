		...
		<div class="right-main-box">
			<div class="right-inner">
				<div class="pro-boxes">
					...
					<p><?php esc_html_e('60+ Premium WordPress Themes', 'healthy-food-blogger'); ?></p>
					<p class="main-bundle-price" ><strong class="cancel-bundle-price"><?php esc_html_e('$2340', 'healthy-food-blogger'); ?></strong><span class="bundle-price"><?php esc_html_e('$86', 'healthy-food-blogger'); ?></span></p>
					...
					<a href="<?php echo esc_url( HEALTHY_FOOD_BLOGGER_PRO_THEME_BUNDLE ); ?>" target="_blank"><?php esc_html_e('Get Theme Bundle For $86', 'healthy-food-blogger'); ?></a>
				</div>
				<div class="pro-boxes pro-theme-container">
					<h4><?php esc_html_e('Healthy Food Blogger Pro', 'healthy-food-blogger'); ?></h4>
					<p class="pro-theme-price" ><?php esc_html_e('$39', 'healthy-food-blogger'); ?></p>
					...
					<a href="<?php echo esc_url( HEALTHY_FOOD_BLOGGER_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Upgrade To Pro At Just at $29.25', 'healthy-food-blogger'); ?></a>
				</div>
