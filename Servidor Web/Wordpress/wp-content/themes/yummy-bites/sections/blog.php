...
$blog_post_options  = get_theme_mod( 'blog_post_options', $defaults['blog_post_options'] );
...
$args = array(  
    ...
    'post_type'           => ($blog_post_options == 'post') ? 'post' : 
    (($blog_post_options == 'recipe' && yummy_bites_is_delicious_recipe_activated()) ? DELICIOUS_RECIPE_POST_TYPE : 
    (yummy_bites_is_delicious_recipe_activated() ? array('post', DELICIOUS_RECIPE_POST_TYPE) : 'post'))
);
                ...
                <div id="primary" class="content-area">
                    <main id="main" class="site-main">
                        <section id="blog_section" class="inner-blog-section">
                                                    ...
                                                    <article <?php post_class( 'post horizontal' ); ?>>
                                                        <figure class="post-thumbnail">
                                                            ...
                                                            if( function_exists( 'yummy_bites_social_share' ) && $ed_social_sharing ) {
                                                                yummy_bites_social_share( $ed_sticky_sharing );
                                                            }
                            ...
                            <?php } else { ?>
                                <div class="no-posts">
                                    <p><?php esc_html_e( 'We couldn’t find any posts to display right now.', 'yummy-bites' ); ?></p>
                                </div>
                            <?php } 
                            wp_reset_postdata(); ?>
