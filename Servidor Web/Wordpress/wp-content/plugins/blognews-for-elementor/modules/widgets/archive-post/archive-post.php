...
class BLOGFOELArchivePost extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'blognews-archive-post';
	}

	public function get_title() {
		return __( 'BN Archive Post', 'blognews-for-elementor' );
	}
	...
	public function get_icon() {
		return 'blogfoel-widget-icon bnicon-archive-post';
	}

	public function get_style_depends() {
		return [
			'blogfoel-widget-icon blognews-post-blog',
		];
	}
		...
		$this->add_control(
			...
			[
				...
				'options'     => [
					...
					'two'   => esc_html__( 'Style 2', 'blognews-for-elementor' ),
				],
