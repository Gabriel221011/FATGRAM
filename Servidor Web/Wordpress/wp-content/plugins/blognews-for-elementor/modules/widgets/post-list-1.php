...
class BLOGFOELPostList1 extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'blognews-post-list-1';
	}

	public function get_title() {
		return __( 'BN Post List 1', 'blognews-for-elementor' );
	}
	...
	public function get_icon() {
		return 'blogfoel-widget-icon bnicon-post-list-1';
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => '1',
				'selectors'       => [
					'{{WRAPPER}} .blogfoel-grid' => 'grid-template-columns: repeat({{VALUE}}, 1fr);',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors'       => [
					'{{WRAPPER}} .blogfoel-grid' => 'grid-column-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors'       => [
					'{{WRAPPER}} .blogfoel-grid' => 'grid-row-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		if (in_array($layout_style, ['layout-one', 'layout-two'])) {
		...
		$layouts = in_array($layout_style, ['layout-one', 'layout-two']) ? '1' : '2';
