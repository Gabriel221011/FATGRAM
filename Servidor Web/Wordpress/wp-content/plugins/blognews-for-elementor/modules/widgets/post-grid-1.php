...
class BLOGFOELPostGrid1 extends \Elementor\Widget_Base {

	private $blog_card_class = 'blogfoel-post-grid-item';
	private $blog_inner_class = 'blogfoel-post-grid-inner';

	public function get_name() {
		return 'blognews-post-grid-1';
	}

	public function get_title() {
		return __( 'BN Post Grid 1', 'blognews-for-elementor' );
	}
	...
	public function get_icon() {
		return 'blogfoel-widget-icon bnicon-post-grid-1';
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'mobile_default'  => ['size' => '', 'unit' => 'px'],
				'selectors'       => [
					'{{WRAPPER}} .'.$this->blog_card_class.':first-child, {{WRAPPER}} .blogfoel-post-grid.layout-two .'.$this->blog_card_class.':first-child + .blogfoel-post-item, {{WRAPPER}} .blogfoel-post-grid.layout-four .'.$this->blog_card_class.':first-child + .blogfoel-post-item' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'mobile_default' => ['size' => '', 'unit' => 'px'],
				'selectors'      => [
					'{{WRAPPER}} .blogfoel-post-grid.layout-one .'.$this->blog_card_class.':not(:first-child), {{WRAPPER}} .blogfoel-post-grid.layout-two .'.$this->blog_card_class.':not(:first-child) + .blogfoel-post-item, {{WRAPPER}} .blogfoel-post-grid.layout-three .'.$this->blog_card_class.':not(:first-child),  .blogfoel-post-grid.layout-four .'.$this->blog_card_class.':not(:first-child) + .blogfoel-post-item' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .'.$this->blog_card_class.':first-child .blogfoel-title, {{WRAPPER}} .blogfoel-post-grid.layout-two .'.$this->blog_card_class.':first-child + .blogfoel-post-item .blogfoel-title, {{WRAPPER}} .blogfoel-post-grid.layout-four .'.$this->blog_card_class.':first-child + .blogfoel-post-item .blogfoel-title',
			]
		);
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
	...
	protected function render() {
		...
		<div class="blogfoel-widget-wrapper">
			<div class="blogfoel-post-grid pg1 layout-one category-bottom <?php echo 'blogfoel-column-' . esc_attr( $columns ) ?>">
